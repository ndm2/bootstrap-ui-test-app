...
class Installer
{
     ...
     * @return void
     */
    public static function runMigrationCommands(string $dir, IOInterface $io): void
    {
     ...
     * @return void
     */
    public static function runBootstrapCommands(string $dir, IOInterface $io): void
    {
        $ds = DIRECTORY_SEPARATOR;
        $cakeCmd = escapeshellarg("{$dir}{$ds}bin{$ds}cake");
     ...
     * @return void
     */
    public static function runBakeCommands(string $dir, IOInterface $io): void
    {
        $ds = DIRECTORY_SEPARATOR;
        $cakeCmd = escapeshellarg("{$dir}{$ds}bin{$ds}cake");
